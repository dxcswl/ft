...
class WxLogin {
	 ...
	 * @param  $state 参数
	 */
	public function get_authorize_url($state,$scope='snsapi_userinfo')
	{
		$authorize_url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$this->appId.'&redirect_uri='.$this->redirect_uri.'&response_type=code&scope='.$scope.'&state='.$state.'#wechat_redirect';
	...
	{
		$info_url = 'https://api.weixin.qq.com/sns/userinfo?access_token='.$access_token.'&openid='.$oppenid.'&lang=zh_CN';
